...
const GoogleReviews = () => {
  ...
  return (
    <section className="w-full py-10 md:py-16 bg-white" id="reviews">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">What Our Clients Say</h2>
        ...
        {businessRating && (
          <div className="text-center mb-10">
            <div className="inline-flex items-center space-x-2 bg-gray-50 px-6 py-4 rounded-lg">
              <div className="text-3xl font-bold text-gray-900">{businessRating.rating}</div>
